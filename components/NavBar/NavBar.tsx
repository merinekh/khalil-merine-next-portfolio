      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto md:flex-nowrap">
        <div className="flex justify-between w-full md:order-2 md:w-40">
          ...
          <Link
            ...
            target="_blank"
            className="resume-download bg-gradient-to-r from-cyan-500 to-teal-500 text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-teal-500 dark:focus:ring-blue-800"
          >
            Resume
          </Link>
        </div>
        <div
          ...
          id="navbar-cta"
        >
          <ul className="flex flex-col py-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link
                href="/"
                className={
